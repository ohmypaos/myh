...
> Sinh tự động từ `lib/versions/current.js` lúc 19:18:25 11/9/2026. Không chép tay.
...
**Rào kín hai cạnh trước / sau — đổi riêng tư lấy nắng mùa đông.** Mặt tiền (`y = 0`) và cạnh sau (`y = 30`, tới `x` 7.9) nay xây kín 2.20 m, không lan can. Đo trên chính khối đã dựng: chỗ giàn phơi (cốt 1.80) ngày **đông chí 5.7 → 2.7 h** nắng trực tiếp, thu phân 7.0 → 4.8 h, hạ chí 9.1 → 8.9 h; giữa cửa D12 của master (cốt 1.20) **đông chí 4.6 → 2.7 h**, thu phân 3.3 → 2.1 h, hạ chí vốn đã 0 h vì trần ban công che. Nói cách khác cái giá dồn hết vào **mùa đông và mùa thu**, đúng mùa mà Bắc Giang cần nắng nhất (`3d.md` mục 2, A0) — hè thì gần như không mất gì. Master vốn chỉ có D12 làm nguồn sáng nên đây là chỗ đau nhất. Muốn lấy lại phần nắng ấy mà vẫn kín thì thay đoạn trên 0.80 m bằng **lam chéo hoặc kính mờ** thay vì xây đặc: nhìn không xuyên qua được nhưng ánh sáng vẫn lọt. Hai cạnh bên `x = 0` và `x = 9.5` giữ rào 1.80 xây đặc 0.80 + lan can, nên từ nhà bên vẫn nhìn thấy sân chính, sân phơi và ban công — muốn kín nữa thì thêm rèm, lam hay cây ở đoạn đó. Cổng chính nay cao 2.20 m theo rào. Ban công cao hơn sân 0.45 nên lan can sau ban công cao 1.35 m tính từ sàn ban công — vẫn trên mức 1.1 m thường đòi cho lan can.
...
- **Rào mặt tiền và rào sau xây kín, cao 2.20 m, bỏ lan can** (chủ nhà chỉnh 11/9/2026 — lấy riêng tư): hai cạnh lộ nhất là mặt tiền quay ra ngõ và cạnh sau quay sang nhà phía sau. Cạnh sau chỉ tới `x = 7.9`, từ đó ra ranh phải đã là tường WC khách. Hai cạnh bên `x = 0` và `x = 9.5` giữ rào 1.80 xây đặc 0.80 + lan can song thoáng. **Cái giá là nắng mùa đông:** chỗ giàn phơi ngày đông chí 5.7 → 2.7 h nắng, thu phân 7.0 → 4.8 h; cửa D12 của master đông chí 4.6 → 2.7 h, thu phân 3.3 → 2.1 h. Mùa hè gần như không đổi
