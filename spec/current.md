...
> Sinh tự động từ `lib/versions/current.js` lúc 19:34:59 11/9/2026. Không chép tay.
...
**Đoạn rào xây kín** — không lan can, đỉnh **2.10 m** so với sân, để che tầm nhìn: trục ngang 0.0 (0.0–9.5); trục ngang 30.0 (0.0–7.9). Cổng và cửa trên đoạn ấy cao theo đỉnh rào.
...
**Rào kín hai cạnh trước / sau — đổi riêng tư lấy nắng mùa đông.** Mặt tiền (`y = 0`) và cạnh sau (`y = 30`, tới `x` 7.9) nay xây kín **2.10 m**, không lan can. Đo trên chính khối đã dựng: chỗ giàn phơi (cốt 1.80) ngày **đông chí 5.7 → 3.4 h** nắng trực tiếp, thu phân 7.0 → 5.4 h, hạ chí 9.1 h không đổi; giữa cửa D12 của master (cốt 1.20) **đông chí 4.6 → 2.8 h**, thu phân 3.3 → 2.2 h, hạ chí vốn đã 0 h vì trần ban công che. Nói cách khác cái giá dồn hết vào **mùa đông và mùa thu**, đúng mùa mà Bắc Giang cần nắng nhất (`3d.md` mục 2, A0) — hè thì gần như không mất gì. Master vốn chỉ có D12 làm nguồn sáng nên đây là chỗ đau nhất. **2.10 là mức vừa đủ, không có dư.** Ban công sau cao hơn sân 0.45 nên rào 2.10 chỉ nhô 1.65 m trên sàn ban công — trên tầm mắt người cao 1.70 m (1.58) đúng 7 cm. Người cao 1.80 m đứng sát rào vẫn nhìn qua được; muốn chắc thì phải 2.20. Đổi lại 2.10 giữ cho giàn phơi thêm 0.7 h nắng đông chí so với 2.20. Muốn lấy lại phần nắng còn mất mà vẫn kín thì thay đoạn trên 0.80 m bằng **lam chéo hoặc kính mờ** thay vì xây đặc: nhìn không xuyên qua được nhưng ánh sáng vẫn lọt. Hai cạnh bên `x = 0` và `x = 9.5` giữ rào 1.80 xây đặc 0.80 + lan can, nên từ nhà bên vẫn nhìn thấy sân chính, sân phơi và ban công — muốn kín nữa thì thêm rèm, lam hay cây ở đoạn đó. Cổng chính nay cao 2.10 m theo rào. Ban công cao hơn sân 0.45 nên lan can sau ban công cao 1.35 m tính từ sàn ban công — vẫn trên mức 1.1 m thường đòi cho lan can.
...
- **Rào mặt tiền và rào sau xây kín, cao 2.10 m, bỏ lan can** (chủ nhà chỉnh 11/9/2026 — lấy riêng tư): hai cạnh lộ nhất là mặt tiền quay ra ngõ và cạnh sau quay sang nhà phía sau. Cạnh sau chỉ tới `x = 7.9`, từ đó ra ranh phải đã là tường WC khách. Hai cạnh bên `x = 0` và `x = 9.5` giữ rào 1.80 xây đặc 0.80 + lan can song thoáng. Chốt 2.10 chứ không 2.20: ban công sau cao hơn sân 0.45 nên rào chỉ cần vượt 0.45 + tầm mắt 1.58 ≈ **2.03 m** là chắn được tầm nhìn từ ban công — chỗ cần kín nhất; cao thêm chỉ mất nắng. **Cái giá là nắng mùa đông:** chỗ giàn phơi ngày đông chí 5.7 → 3.4 h nắng, thu phân 7.0 → 5.4 h; cửa D12 của master đông chí 4.6 → 2.8 h, thu phân 3.3 → 2.2 h. Mùa hè gần như không đổi
