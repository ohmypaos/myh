...
/* Mái nhẹ (tôn) — bề dày tấm lợp và tấm trần, mét. Cố ý **không** nằm trong HEIGHTS: đó là
   bề dày vật liệu chứ không phải cao độ thiết kế, không có thanh trượt nào chỉnh tới. Cao độ
   khai ở `v.roofs` là **mặt dưới** mái, tấm lợp nằm trên đó. */
export const ROOF = {sheet:0.05, ceiling:0.02};
