...
export const TANK = {dia:0.96, len:1.59, stand:0.60, leg:0.05, pad:0.30, padThick:0.02, volume:1000,
  mat:'bồn inox 1000 L nằm ngang, giá thép sơn, chân có bản đế dàn tải'};

/* Giàn phơi ngoài trời, mét. Tuyến khai ở `racks` của mặt bằng — `[mã, trục, vị trí, từ, đến]`, cùng dạng
   với tuyến tường và lan can; hình học suy ra: hai trụ thép hộp `post` cao `height` ở hai đầu tuyến, giữa
   là `levels.length` thanh phơi inox Ø `bar` ở các cao độ ấy.
   ...
   Cao độ thanh trên cùng 1.80 để đồ dài không chạm sân; ba thanh cách nhau 0.25 đủ cho quần áo không dính
   vào nhau. */
export const RACK = {post:0.05, height:1.90, bar:0.027, levels:[1.30, 1.55, 1.80],
  mat:'giàn phơi trụ thép hộp 50 × 50 sơn tĩnh điện, thanh phơi inox Ø27'};
