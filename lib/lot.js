...
/* Bậc tam cấp, mét. Cốt nền chia nấc `rise` (0.45 / 0.15 = 3 nấc); nấc trên cùng chính là sàn
   nhà nên chỉ dựng 2 bậc ngoài, nhô 2 × `tread`. Kéo thanh trượt cốt nền thì số bậc đổi theo.
   `margin` là phần bậc rộng hơn cửa mỗi bên. Cửa nào có bậc thì khai mã cửa ở `steps` của mặt
   bằng; vị trí suy trong lib/envelope.js. */
export const STEP = {rise:0.15, tread:0.30, margin:0.30};
