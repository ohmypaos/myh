...
/* Cột đỡ mái nhẹ, mét. Vị trí khai ở `posts` của mặt bằng; chiều cao **suy ra** — từ cốt sân lên tới mặt
   dưới tấm mái ngay trên cột, hoặc tới đáy máng nếu máng chạy qua đầu cột (lib/envelope.js). Thép hộp
