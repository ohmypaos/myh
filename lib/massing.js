...
function buildSlabs(v, H, L){
  ...
  boxes.push({ x: CARPORT_ROOF.x, w: CARPORT_ROOF.w,
               z: CARPORT_ROOF.fromY - CARPORT_ROOF.length, d: CARPORT_ROOF.length,
               y0: CARPORT_ROOF.height - 0.1, y1: CARPORT_ROOF.height, kind: 'carportRoof' });
