...
import { isEnclosed, floorOf, roomsAlong, openingFloor, stepsOf, overhangsOf, jointHalf, wallThickness,
         ...
         lightsOf, switchesOf } from './envelope.js';
...
export function buildMassing(v, { doorsOpen = true } = {}){
  ...
  const extra = [...insulation, ...st.boxes, ...tanks, ...racks.boxes, ...gateRoofs.boxes, ...gateDoors, ...buildFurniture(v, L), ...buildDoorLeaves(v, H, L, doorsOpen), ...lamps, ...buildSwitches(v)];
