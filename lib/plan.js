...
import { levels, openingFloor, underStairsOf, isUnderStair, stepsOf, overhangsOf, lightRoofs, roofOver, dropCeilingsOf, postsOf, roofInsulationOf,
...
export function validate(v){
  ...
  for(const s of stairsOf(v)){
    ...
    for(const [k,fx,fy,fw,fh] of v.furn)
      if(ovl(x,x+w,fx,fx+fw)>0.02 && ovl(y,y+h,fy,fy+fh)>0.02 && !inNest(fx,fx+fw,fy,fy+fh))
