/* Diện tích thông thủy và 14 phép kiểm — tách từ bản vẽ HTML một-file trước đây.
...
export const CHECKS = [
  ...
  'Bậc, mái hiên, cốt sàn riêng khai đúng cửa, tường, phòng; bậc nằm gọn trong sân, không vướng nội thất hay cánh cửa',
];
