...
import { frontAzimuth } from './config.js';

const rad = d => d * Math.PI / 180;
const deg = r => r * 180 / Math.PI;

/* Nơi xây đã chốt và nằm ở LOT (lib/lot.js), không còn danh sách thành phố để chọn.
   Muốn đối chiếu với nơi khác thì truyền thẳng lat/lon khác vào sunPosition() — hàm vốn
   nhận tham số, không cần bảng. */
